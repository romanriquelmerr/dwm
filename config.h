...
static const char *colors[][3] = {
    ...
    {material.active, material.bg, material.focus},

    // Tema Dracula
    {dracula.inactive, dracula.bg, window_border},
    {dracula.active, dracula.bg, dracula.focus},

    // Tema Nord
    {nord.inactive, nord.bg, window_border},
    {nord.active, nord.bg, nord.focus},

    // Tema Monokai Pro
    {monokai_pro.inactive, monokai_pro.bg, window_border},
    {monokai_pro.active, monokai_pro.bg, monokai_pro.focus},

    // Tema Onedark
    {onedark.inactive, onedark.bg, window_border},
    {onedark.active, onedark.bg, onedark.focus},

    // Tema Gruvbox
    {gruvbox.inactive, gruvbox.bg, window_border},
    {gruvbox.active, gruvbox.bg, gruvbox.focus},

    // Tema Solarized Dark
    {solarized_dark.inactive, solarized_dark.bg, window_border},
    {solarized_dark.active, solarized_dark.bg, solarized_dark.focus},

    // Tema Tomorrow Night
    {tomorrow_night.inactive, tomorrow_night.bg, window_border},
    {tomorrow_night.active, tomorrow_night.bg, tomorrow_night.focus},
};
